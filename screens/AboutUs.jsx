  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.txtContainer}>
        ...
        <Text style={styles.txt}>
          Sed blandit mauris quis interdum suscipit. Maecenas hendrerit justo
          vitae lobortis interdum. Donec pulvinar massa et arcu posuere
          pulvinar. Sed eu vestibulum sem, at vehicula elit.
        </Text>
      </View>
